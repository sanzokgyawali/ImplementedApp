	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('/metro')}}"><span>Metro</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('admin/allcategory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="{{url('admin/addcategory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{url('admin/brand/show_brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li><a href="{{url('admin/brand/add_brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{url('admin/product/add_product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delevery Through</span></a></li>

						<?php
						if(Session::get('admin_role')=='super'){

						?>
						<li><a href="calendar.html"><i class="icon-calendar"></i><span class="hidden-tablet"> Add Admin</span></a></li>
							<li><a href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> All Admin</span></a></li>
						<?php } ?>
