				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('backend/images/home/logo.png')}}" alt="" /></a>
						</div>
	...
	<section>
		<div class="container">
			<div class="row">
              ...
              @foreach($rescat as $r)
              <?php
              $cat=preg_replace("/\s+/","",$r->category_name);
               ?>
							<div class="panel panel-default">
								...
								<div id="<?php echo $cat ?>" class="panel-collapse collapse">
									<div class="panel-body">
										...
										@foreach($res as $re)
                    @if($re->category_id==$r->category_id)
                    <li><a href="#">{{$re->manufacture_name}} </a></li>
                    @endif
                    @endforeach
										</ul>
									</div>
